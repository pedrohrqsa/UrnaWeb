...
namespace Project_Urna
{
    class ClnListar
    {
        public DataSet ListarMesarios(string strListarMesario){
            string strQuery;
        ...
        public DataSet ListarAlunos(string strListaAluno){
            string strQuery;
        ...
        public DataSet ListarChapas(string strListaChapas){
            String strQuery;
